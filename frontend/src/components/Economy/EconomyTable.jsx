...
import { Table, TableHead, TableBody, TableRow, TableCell, IconButton, Paper } from '@mui/material';
...
const EconomyTable = () => {
  ...
  const fetchData = async () => {
    const res = await api.get('/economy');
    setData(res.data);
  };
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">Hộ nghèo</TableCell>
            <TableCell align="center">Hộ cận nghèo</TableCell>
            <TableCell align="center">Thu nhập</TableCell>
            <TableCell align="center">Số thôn</TableCell>
            <TableCell align="center">Hộ KD nhỏ</TableCell>
        ...
        <TableBody>
          {data.map((row, index) => (
            <TableRow key={row.id} sx={{
              ...
              <TableCell align="center">{row.so_ho_ngheo}</TableCell>
              <TableCell align="center">{row.so_ho_can_ngheo}</TableCell>
              <TableCell align="center">{row.thu_nhap_binh_quan}</TableCell>
              <TableCell align="center">{row.so_thon}</TableCell>
              <TableCell align="center">{row.so_ho_kinh_doanh_nho_le}</TableCell>
