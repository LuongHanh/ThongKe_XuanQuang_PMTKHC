// pages/admin/EthnicGroupsTable.jsx
import { useEffect, useState, useRef } from 'react';
import api from '../../services/api';
import {
  Table, TableHead, TableBody, TableRow, TableCell, IconButton, Paper
} from '@mui/material';
import EthnicGroupsForm from './EthnicGroupsForm';
import DeleteIcon from '@mui/icons-material/Delete';
import EditIcon from '@mui/icons-material/Edit';

const EthnicGroupsTable = () => {
  ...
  const handleDelete = async (id) => {
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        await api.delete(`/ethnic-groups/${id}`, {
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">Tên dân tộc</TableCell>
        ...
        <TableBody>
          {data.map((row, index) => (
            <TableRow key={row.id} sx={{
              ...
              <TableCell align="center">{row.ten_dan_toc}</TableCell>
              <TableCell align="center">{row.so_luong}</TableCell>
...
export default EthnicGroupsTable;
